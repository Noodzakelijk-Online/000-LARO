...
| Document analysis | understands source content | deterministic extraction for TXT, CSV, HTML, EML, PDF, and DOCX plus local Dutch/English image OCR; optional provider findings are retained only with valid source citations |
...
unimplemented operation. Unsupported formats and optional providers report their
