...
import { Loader2, Plus, X, Search, Calendar, Mail, Play, Settings2, Sparkles } from "lucide-react";
...
export function AutoCollectionSettings({ caseId }: AutoCollectionSettingsProps) {
  ...
  useEffect(() => {
    if (settingsData?.settings) {
      ...
      setKeywordMatchMode(s.keywordMatchMode || "any");
      setSelectedAccountIds(s.emailAccountIds || []);
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            <Select value={keywordMatchMode} onValueChange={(v) => setKeywordMatchMode(v as "all" | "any")}>
